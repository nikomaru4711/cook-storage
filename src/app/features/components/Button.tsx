...
export function Button({ onClick, text, className, buttonColorType }: ButtonElement) {
    const Styles = {
    ...
    return (
        <button 
            ...
            className={isPresetColor ? Styles[buttonColorType as keyof typeof Styles] : `px-3 py-1 text-white rounded ${className || ''}`}
